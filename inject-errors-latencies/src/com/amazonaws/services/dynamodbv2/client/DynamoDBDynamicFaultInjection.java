...
/**
 * This sample demonstrates how to inject failures, latencies in your DynamoDB client for testing
 */
public class DynamoDBDynamicFaultInjection {
     ...
     *            sample and configure your log4j.properties
     *            
    ...
    private static void init() throws Exception {
        ...
        RequestHandler requestHandler =  new FaultInjectionRequestHandler(dynamoDBClient);

...
public class QueryWithProjectionExpression {
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            // Get items in the Customer table and only return name and status
            Iterator<Customer> results = table.query(r -> r.queryConditional(queryConditional)

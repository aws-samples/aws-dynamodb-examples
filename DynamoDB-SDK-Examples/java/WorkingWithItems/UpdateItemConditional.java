...
public class UpdateItemConditional {
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            // Update expression, change name only if age is greater than 21.
            final Expression expression = Expression.builder()
                    .expression("#a > :age")
                    .putExpressionName("#a", "age")
                    .putExpressionValue(":age", AttributeValue.builder().n("21").build())
                    .build();
            ...
            UpdateItemEnhancedRequest request =
                    UpdateItemEnhancedRequest.builder(Customer.class)
                            .item(customer)

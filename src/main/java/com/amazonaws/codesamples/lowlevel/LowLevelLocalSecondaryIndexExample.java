...
public class LowLevelLocalSecondaryIndexExample {
    ...
    public static void loadData() {
        ...
        item.put("ProductName",
                new AttributeValue().withS(" The Great Outdoors"));
        ...
        PutItemRequest putItemRequest = new PutItemRequest().withTableName(
                tableName).withItem(item).withReturnItemCollectionMetrics(ReturnItemCollectionMetrics.SIZE);
        ...
        putItemRequest = new PutItemRequest().withTableName(tableName)
                .withItem(item).withReturnItemCollectionMetrics(ReturnItemCollectionMetrics.SIZE);
        ...
        item.put("ProductName",
                new AttributeValue().withS("Extra Heavy Hammer"));
        item.put("OrderStatus", new AttributeValue().withS("PACKING ITEMS"));
        /* no ShipmentTrackingId attribute */
        putItemRequest = new PutItemRequest().withTableName(tableName)
                .withItem(item).withReturnItemCollectionMetrics(ReturnItemCollectionMetrics.SIZE);
        ...
        item.put("ProductName",
                new AttributeValue().withS("Really Big Suitcase"));
        item.put("OrderStatus", new AttributeValue().withS("DELIVERED"));
